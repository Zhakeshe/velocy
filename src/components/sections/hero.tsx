  ...
  return (
    <section className="relative min-h-[100vh] flex flex-col overflow-hidden bg-black">
      ...
      <div className="relative z-10 flex-1 w-full flex items-center">
        <div className="relative z-20 flex flex-col items-start gap-6 md:gap-8 px-4 sm:px-6 lg:px-16 xl:px-24 py-20 md:py-32 max-w-full md:max-w-[60%] lg:max-w-[50%]">
        ...
        {/* Mobile spiral - background, higher and to the right */}
        <div className="flex md:hidden absolute inset-0 items-center justify-end pointer-events-none z-0">
          <div className="absolute top-[30%] right-[5%] w-[60%] h-[40%] bg-blue-600/20 blur-[100px] rounded-full"></div>
          <div className="relative w-[70%] max-w-[320px] translate-y-[15%] translate-x-[10%] opacity-60">
            <img
              src="/10.png"
              alt="Hero Graphic"
        ...
        {/* Desktop spiral - original position */}
        <div className="hidden md:flex absolute right-[-5%] bottom-0 w-[70%] lg:w-[55%] h-full pointer-events-none items-end justify-end">
